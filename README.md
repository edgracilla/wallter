...
**dropRule(*path, rules*)**                     | Remove validation rule from schema item<br><br>***params:*** *path {string}  - path to property to validate* <br>***params:*** *rules {string\|string[]}  - validation rule names to remove*
